...
Step 1: Get windows server on my other PC so I can use that to host the active directory and then I can use my main PC to connect to it and host VM's to simulate multiple users. I dont have a flash drive available so I'll have to install directly from windows 10.
